            ...
            <div class="text">
                ...
                <div class="address">
                    ...
                    <div class="location">
                        ...
                        <i class="fa-solid fa-phone"></i><p>+1234567890</p><br>
                        <i class="fa-solid fa-location-pin"></i><p>123 street, new,york</p><br>
                        <i class="fa-solid fa-envelope"></i><p>investmento@example.com</p><br>
    ...
    <section class="feedback-container">
        ...
        <div class="phone">
            ...
            <form action="" method="post">
                ...
                <textarea name="feedback" id="feedback" placeholder="write your complain here"></textarea>
